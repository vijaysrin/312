...
void testStage5(void){
  UTString* utstr1 = utstrdup("I love to eat cheese and crackers with sour cream");
  char p[200] = ",but i hate when i run out of guac!!\n\nYou know what i mean??";
  utstrrealloc(utstr1, 200);
  utstrcat(utstr1, p);
  printf("%s\n", utstr1->string);
  utstrfree(utstr1);
}
